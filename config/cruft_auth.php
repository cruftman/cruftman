...
return [
    ...
    */
    'connections' => [
        'ldap1' => [
            'uri' => env('AUTH_LDAP1_URI', 'ldap://cruftman.local'),
            // 'options' => [],
    ...
    */
    'bindings' => [
        'auth@london.example.org' => [
            'dn' => 'cn=cruftUserAuth,cn=cruftman.example.org,ou=servers,ou=systems,ou=london,dc=example,dc=org',
            'password' => 'london'
        ],
        'auth@manchester.example.org' => [
            'dn' => 'cn=cruftUserAuth,cn=cruftman.example.org,ou=servers,ou=systems,ou=manchester,dc=example,dc=org',
            'password' => 'manchester'
        ]
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | Named filters used when searching LDAP databases for users
    */
    'filters' => [
        'enabled_user' => '(&(objectclass=inetorgperson)'.
