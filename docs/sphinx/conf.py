...
project = 'Cruftman Inventory'
copyright = '2019, Cruftman Team'
author = 'Cruftman Team'
...
latex_documents = [
    (master_doc, 'Cruftman.tex', 'Cruftman Documentation',
     'Cruftman Team', 'manual'),
]
...
man_pages = [
    (master_doc, 'cruftman', 'Cruftman Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Cruftman', 'Cruftman Documentation',
     author, 'Cruftman', 'One line description of project.',
     'Miscellaneous'),
]
